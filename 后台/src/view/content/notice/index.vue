        ...
        <Form :model="formItem" :label-width="80">
            <FormItem label="">
                    ...
                    <Col span="11">
                        ...
                        <Button type="primary" @click="addNotice">添加公告</Button>
            </FormItem>
        </Form>
        <!-- height属性：固定表头 -->
...
<script>
import {  listNotice, delNotice } from '@/api/content'
export default {
    data () {
        return {
             formItem: {
            ...
            tableColumns: [                     // 表格列
                {
                    ...
                    render: (h, params) => {
                        return h('div', {
                        }, params.index+(this.pageData.curPage-1)*this.pageData.pageSize+1);
                    },
                    minWidth:150,
                },
                {
                ...
                //     minWidth:150,
                //     render: (h, params) => {
                //         const btn=params.row.details.replace(/<\/?[^>]*>/g,'').substring(0,10)+'...';
                //         return h('div',{},btn);
                //     }
                // },
                {
                    ...
                    minWidth:150,
                    render: (h, params) => {
                        return h('div',{},this.$public.timestampToTimeYMDhms(params.row.timestamp,2));
                    }
                },
                {
                    title: '操作',
    ...
    methods: {
        ...
        // 添加公告
        addNotice () {
            this.$router.push("/content/addtonotice")
        },
        ...
        mockTableData () {
            ...
            listNotice(_data ).then(function(response) {
        ...
        // 编辑
        edit (id) {
            this.$router.push({ name: 'addtonotice', params: { userId: id }})
        },
        ...
        remove (id) {
            ...
            _this.$Modal.confirm({
                ...
                content: '确定要删除该条信息么？',
                onOk: () => {
                    delNotice({id: id}).then(function(response) {
                        if(response.data.code == 200){
