        ...
        <Form :model="formItem" :label-width="80">
            <FormItem label="">
                    ...
                    <Col span="11">
                        ...
                        <Button type="primary" @click="addNotice">添加交易指南</Button>
            </FormItem>
        </Form>
        <!-- height属性：固定表头 -->
...
<script>
import {  listRule, delRule } from '@/api/content'
export default {
    data () {
        return {
             formItem: {
    ...
    methods: {
        ...
        // 添加公告
        addNotice () {
            this.$router.push("/content/addtoguide")
        },
        ...
        mockTableData () {
            ...
            listRule(_data ).then(function(response) {
        ...
        remove (id) {
            ...
            _this.$Modal.confirm({
                ...
                content: '确定要删除该条信息么？',
                onOk: () => {
                    delRule({id: id}).then(function(response) {
                        if(response.data.code == 200){
